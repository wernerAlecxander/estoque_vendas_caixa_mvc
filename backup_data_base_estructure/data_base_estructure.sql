...
--------------------------------------------------------------------------------
CREATE TYPE nivel_acesso AS ENUM ('1', '2', '3', '4');
...
CREATE TABLE usuarios (
    ...
    nivel_acesso nivel_acesso DEFAULT '1' NOT NULL,
...
-- Inserindo um carro fake de exemplo para o banco não nascer vazio
INSERT INTO veiculos_sucata (ID, marca_veiculo, modelo_ID,  ano_fabricacao, ano_modelo, chassi, cor, status_sucata, responsavel_compra_id data_entrada)
VALUES ('da009a72-132d-45db-99e2-3ba28fef6f82', 'Fiat', 1, 2012, 2012, 'ABC123DEF456GHI789JKL012MNO345PQR678STU901VWX234YZA567', 'Preto', 'Em desmonte', CURRENT_TIMESTAMP);

-- inserindo uma peça fake de exemplo para o banco não nascer vazio
INSERT INTO pecas (ID, veiculo_origem_ID, nome_peca, modelo_origem_ID, modelo_origem_nome, categoria, preco, responsavel_compra_ID, responsavel_compra_nome, status_peca, localizacao_peca, setor_prateleira, data_cadastro)
VALUES ('e1a2b3c4-d5f6-7890-abcd-ef1234567890', 'da009a72-132d-45db-99e2-3ba28fef6f82', 'Motor Completo', 1, 'Strada', 'Motor e componentes', 1500.00, 'Tizolin', 'Tizolin', 'Disponivel', 'prateleira', 'setor1', CURRENT_TIMESTAMP);
...
--visualizar os dados inseridos dentro da tabela veiculos_sucata via enum
SELECT enum_range(null::status_veiculo);
